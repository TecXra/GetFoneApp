...
public class MainActivity extends AppCompatActivity implements AsyncResponse {
    ...
    ArrayList<ContactsData> contactList = new ArrayList<ContactsData>();
  ...
  //              new IntentFilter("com.receive"));
    ...
    public void sync(View view)
    {
        ...
        GetFoneContactModel myContact = new GetFoneContactModel();

             contactList = myContact.getContacts(MainActivity.this);

        Toast.makeText(MainActivity.this, "Contacts have been fetched :", Toast.LENGTH_SHORT).show();
        RequestExecutor executor = new RequestExecutor(MainActivity.this);
       executor.delegate = MainActivity.this;
        executor.execute("1",contactList);
